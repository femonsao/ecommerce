<?php if(!class_exists('Rain\Tpl')){exit;}?><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
    ...
    <input type="hidden" name="business" value="femonsao@gmail.com">
    ...
    <input type="hidden" name="shipping_1" value="<?php echo htmlspecialchars( $order["vlfreight"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
