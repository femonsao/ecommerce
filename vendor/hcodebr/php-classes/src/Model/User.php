...
class User extends Model
{
    ...
    public static function setErrorRegister($msg)
    {
        ...
        $_SESSION[User::ERROR_REGISTRER] = $msg;
    }

    public static function getErrorRegister()
    {

        $msg = (isset($_SESSION[User::ERROR_REGISTRER]) && $_SESSION[User::ERROR_REGISTRER]) ? $_SESSION[User::ERROR_REGISTRER] : '';
    ...
    public static function clearErrorRegister()
    {
        ...
        $_SESSION[User::ERROR_REGISTRER] = NULL;
    }
